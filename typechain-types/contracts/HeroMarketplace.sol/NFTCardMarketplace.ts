...
export declare namespace NFTCardMarketplace {
...
export interface NFTCardMarketplaceInterface extends utils.Interface {
  functions: {
...
export interface NFTCardMarketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTCardMarketplaceInterface;
  ...
  functions: {
    ...
    ): Promise<[NFTCardMarketplace.ListDetailStructOutput[]]>;
