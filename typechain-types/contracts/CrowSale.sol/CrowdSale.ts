...
export interface CrowdSaleInterface extends utils.Interface {
  functions: {
    ...
    "buyTokenByBNBT()": FunctionFragment;
    "buyTokenByUSDT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "buyTokenByBNBT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrowdSale extends BaseContract {
  ...
  callStatic: {
    ...
    buyTokenByBNBT(overrides?: CallOverrides): Promise<void>;

    buyTokenByUSDT(overrides?: CallOverrides): Promise<void>;
